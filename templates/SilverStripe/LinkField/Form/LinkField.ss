...
<div data-field-id="$ID" data-schema-component="$SchemaComponent" class="entwine-linkfield" data-types="$TypesProp">
  <div class="link-field__container">
    ...
    <div>
        <div class="link-picker__link link-picker__link--is-first link-picker__link--is-last form-control link-picker__link--disabled link-picker__link--published" role="button" aria-disabled="false" roledescription="sortable" aria-describedby="" id="link-picker__link-42">
